...
<body>
	<div class="container">
    <div class="col-sm-6">
			<a href="<?php echo site_url('C_Karyawan') ?>" class="btn btn-primary" > <span>	User</span></a>
			<a href="<?php echo site_url('C_Karyawan/get_motor') ?>" class="btn btn-primary" > <span>Motor</span></a>
			<a href="<?php echo site_url('C_Karyawan/get_cicil') ?>" class="btn btn-primary" > <span>Cicilan</span></a>
			<a href="<?php echo site_url('C_Karyawan/get_uangmuka') ?>" class="btn btn-primary" > <span>Uang Muka</span></a>
			<a href="<?php echo site_url('C_Karyawan/get_penjualan') ?>" class="btn btn-primary" > <span>Penjualan</span></a>
		</div>
		<div class="table-wrapper">
            ...
            <?php
						...
						foreach ($penjualan as $key) {
							...
							<td>
								<?php echo $key->harga_motor ?>
							</td>
							<td>
								<?php echo $key->tenor ?>
							</td>
              <td>
								<?php echo $key->uang_muka ?>
							</td>
              <td>
								<?php echo $key->cicilan_pokok ?>
							</td>
              <td>
								<?php echo $key->cicilan_bunga ?>
							</td>
              <td>
